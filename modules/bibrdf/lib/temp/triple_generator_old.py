    ...
    def iter_generate_triple(self, node, item_data_object, parent = None):
        ...
        if children:
            for item in item_data_object[node.tag]:
                ...
                self.item_data_object_rdflist.append( ( ('URI', str(item_data_object)), ('URI', ont), ('URI', str(item)), ('URI', item_data_object) )  )
                print item, ' a ', node.attrib["as"]
                self.item_data_object_rdflist.append( ( ('URI', str(item)), ('Keyword', 'a'), ('URI', node.attrib["as"]), ('URI', str(item)) )  )
            ...
            if item_data_object[node.tag]:
                ...
                self.item_data_object_rdflist.append( ( ('URI', item_data_object["id"][0]), ('URI', ont), ('Literal', item_data_object[node.tag][0]), ('URI', item_data_object["id"][0]) )  )
